    ...
    <BaseField :name="name" :label="label" :description="description" :required="required" :form="form">
        <div class="mt-1 relative rounded-md shadow-sm">
            <input :type="type" :name="name" :id="name" :autocomplete="autocomplete" :min="min" :max="max"
                   ...
                   class="block w-full pr-10 border-gray-300 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm rounded-md disabled:bg-gray-100 disabled:cursor-not-allowed disabled:border-gray-400 disabled:opacity-70"
